...
void Test4VertexBuffer::Init() {
	...
	basicEffect->parameters.world = VF::Math::rotate(VF::Math::Matrix4(1.0f), VF::Math::radians<float>(0), VF::Math::Vector3(0, 0, 1)) * VF::Math::translate(VF::Math::Matrix4(1.0f), VF::Math::Vector3(0, 0, 0));
	basicEffect->parameters.projection = VF::Math::transpose(basicEffect->parameters.projection);
	basicEffect->parameters.view = VF::Math::transpose(basicEffect->parameters.view);
	basicEffect->parameters.world = VF::Math::transpose(basicEffect->parameters.world);
}
